      ...
      <div className="Aboutuspage">
        <div className="aboutonep">
          ...
          <div className="para">
            ...
            <p>At Paradkar Hospital, patients and their family are at the core of everything we think, feel, and do. Your specific needs and unique life experiences inspire us to:</p>
